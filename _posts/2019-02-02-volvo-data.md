...
The major contribution to overall sales growth was driven by China ***(14.1%)***<br> and US ***(20.6%)***<br>. In comparison with December'17 we see the slight demand slowdown in Europe region ***(-1.3%)*** and US ***(-8.8%)***. However, total December volumes represent sustainable growth year over year. <br>
